              ...
              <div key={user.id} className="bg-white rounded-lg border shadow-sm p-4">
                ...
                {user.physiotherapist && (
                  <p className="text-sm text-gray-600 mb-3">
                    <span className="font-medium">Fisioterapeuta:</span> {user.physiotherapist.name}
                  </p>
                )}
                ...
                <div className="space-y-2">
                  <button
                    onClick={() => handleEditUser(user)}
                    className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 active:bg-blue-800 transition-colors"
                  >
                  ...
                  <div className="flex gap-2">
                    <button
                      onClick={() => handleResetPassword(user.id, user.name)}
                      className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-gray-50 text-gray-700 border border-gray-200 rounded-lg font-medium hover:bg-gray-100 active:bg-gray-200 transition-colors"
                    >
                      Resetar Senha
                    </button>
                    {String(session?.user?.id) !== user.id && (
